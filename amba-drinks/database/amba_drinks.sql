-- =====================================================
-- Database : amba_drinks
-- Proyek   : AMBA DRINKS (MVC, multi-role pembeli & penjual)
-- =====================================================
-- File ini SUDAH LENGKAP. Cukup impor SEKALI lewat phpMyAdmin
-- (tab Import) atau jalankan di tab SQL. Berisi:
--   1. Pembuatan database
--   2. Tabel users & produk
--   3. Data produk contoh
--   4. Satu akun penjual contoh (login manual)
-- =====================================================

CREATE DATABASE IF NOT EXISTS amba_drinks
...
-- ----------------------------------------------------
-- Akun PENJUAL contoh (tidak bisa dibuat lewat register)
--   Email    : penjual@amba.com
--   Password : penjual123
-- ----------------------------------------------------
INSERT INTO users (nama, email, password, role)
VALUES ('Penjual Satu', 'penjual@amba.com', '$2y$10$I6fL8JAIG5QgF/1uNR.QFeMMOM1FBiQulHaQF.JaU1Fe1zpdP4vxe', 'penjual');
